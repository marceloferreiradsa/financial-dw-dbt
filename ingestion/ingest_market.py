"""
Ingestão de cotações históricas B3 via yfinance (Yahoo Finance).
Tickers brasileiros têm sufixo .SA (ex: PETR4.SA).
"""
...
def fetch_ticker(ticker: str, start: str, end: str) -> pd.DataFrame:
    ...
    auto_adjust=False mantém preços nominais + adj_close separado,
    permitindo análises que precisam distinguir os dois.
    """
